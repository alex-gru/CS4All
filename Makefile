...
test: selfie
	./selfie -c selfie.c -o selfie1.m -s selfie1.s -m 5 -c selfie.c -o selfie2.m -s selfie2.s
	diff -q selfie1.m selfie2.m
	diff -q selfie1.s selfie2.s
	./selfie -c selfie.c -o selfie.m -m 5 -l selfie.m -m 5
	./selfie -c selfie.c -o selfie3.m -s selfie3.s -y 5 -l selfie3.m -y 5 -l selfie3.m -y 5 -c selfie.c -o selfie4.m -s selfie4.s
	diff -q selfie3.m selfie4.m
	diff -q selfie3.s selfie4.s
	diff -q selfie1.m selfie3.m
	diff -q selfie1.s selfie3.s
	./selfie -c selfie.c -o selfie5.m -s selfie5.s -min 5 -l selfie5.m -y 5 -l selfie5.m -y 5 -c selfie.c -o selfie6.m -s selfie6.s
